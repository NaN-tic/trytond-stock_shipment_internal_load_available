...
MODULE = 'stock_internal_shipment_move'
PREFIX = 'nantic'
MODULE2PREFIX = {}
OWNER = {
    'nantic':'NaN-tic',
...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    url='https://github.com/NaN-tic/trytond-stock_internal_shipment_move',
    download_url='https://github.com:nantic/trytond-stock_internal_shipment_move.git',
    ...
    project_urls = {
       "Source Code": 'https://github.com:NaN-tic/trytond-stock_internal_shipment_move.git'
    },
    classifiers=[
